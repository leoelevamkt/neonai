...
export default function Plans() {
  return (
    <section id="planos" className="py-20 sm:py-28 relative overflow-hidden">
      {/* Background effects */}
      <div className="absolute top-1/4 left-10 w-72 h-72 bg-brand-cyan/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-1/4 right-10 w-80 h-80 bg-brand-pink/10 rounded-full blur-3xl"></div>
