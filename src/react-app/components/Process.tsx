  ...
  return (
    <section id="processo" className="py-20 sm:py-28 relative overflow-hidden" ref={sectionRef}>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-24 sm:space-y-32">
            {processSteps.map((step, index) => (
              <div
                ...
                className={`relative flex items-center flex-col lg:${
              ...
              >
                ...
                <div className={`w-full lg:w-5/12 ${
                  index % 2 === 0 ? 'lg:pr-12 text-left lg:text-right' : 'lg:pl-12 text-left'
                }`}>
                  <div
                  ...
                  >
                    <div className="glass rounded-2xl p-6 sm:p-8 shadow-neon hover:scale-105 transition-all duration-300 group">
                      <div className={`flex items-center gap-4 ${
                        index % 2 === 0 ? 'lg:flex-row-reverse lg:justify-start' : 'flex-row'
                      } mb-4`}>
                ...
                <div className={`w-full lg:w-5/12 hidden lg:flex ${
                  ...
                  <div
                    ...
                    style={{ transitionDelay: `${index * 300}ms` }}
                  >
                    <div className={`inline-flex items-center justify-center w-20 h-20 lg:w-24 lg:h-24 rounded-full font-display font-bold text-2xl lg:text-3xl transition-all duration-500 shadow-lg ${
                      getStepStatus(index) === 'active'
                        ? 'bg-gradient-to-r from-brand-cyan to-blue-500 text-white scale-110 animate-pulse shadow-cyan-500/50'
                        : getStepStatus(index) === 'completed'
                        ? 'bg-gradient-to-r from-emerald-400 to-teal-500 text-white shadow-emerald-500/50'
        ...
        {/* Call to action */}
        <div className="text-center mt-16 sm:mt-20" data-aos="fade-up" data-aos-delay="800">
